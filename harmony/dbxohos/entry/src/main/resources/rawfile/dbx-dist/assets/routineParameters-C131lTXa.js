import{Ci as e,ta as t}from"./api-CKPKBL3D.js";async function n(n){if(n.databaseType===`xugu`)return a((await t(n.connectionId,n.database,n.schema||n.database,n.routineName,`PROCEDURE`)).source).parameters;let r=i(n);return r?_(await e(n.connectionId,n.database,r,n.schema,void 0,{maxRows:200,pageSize:200}),n.databaseType):[]}function r(e){return e===`postgres`||e===`mysql`||e===`doris`||e===`starrocks`||e===`sqlserver`||e===`oracle`||e===`dameng`||e===`oceanbase-oracle`||e===`databend`||e===`xugu`}function i(e){if(!r(e.databaseType))return null;let t=E(e.schema||(e.databaseType===`postgres`?`public`:``)||(e.databaseType===`mysql`||e.databaseType===`doris`||e.databaseType===`starrocks`?e.database:``)),n=E(e.routineName);return e.databaseType===`postgres`?`
SELECT
