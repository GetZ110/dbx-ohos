import{n as e}from"./rolldown-runtime-Dd_uD5pT.js";import{Yf as t,z as n}from"./api-CcAcmJXL.js";var r=e({formatCsv:()=>i,formatSqlInsert:()=>o,formatTsv:()=>a});function i(e,n,r=`all`){return`${e.map(e=>t(e,r)).join(`,`)}\n${n.map(e=>e.map(e=>e===null?``:t(String(e),r)).join(`,`)).join(`
